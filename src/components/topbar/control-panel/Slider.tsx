  ...
  return (
    <form>
      <SliderRadiux.Root
        ...
        step={1}
      >
        <SliderRadiux.Track className="relative grow h-full w-full bg-topbar-control-range-background rounded-full overflow-hidden shadow-inner">
          <SliderRadiux.Range
            className={cn(
              "absolute bg-topbar-control-range-active h-full left-0 ",
              {
